 ...
 * Server Component — only the CopyButton is a client island.
 */
    ...
    >
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, var(--t-glow1), transparent 68%)",
          pointerEvents: "none",
        }}
      />
      ...
      <Container variant="narrow">
        <Stack direction="column" gap="lg" style={{ position: "relative" }}>
          ...
          <a
            ...
            className="rv d4 sc-contact-cta-primary"
            style={{
              display: "flex",
              alignItems: "center",
              ...
              borderRadius: 12,
              background:
                "linear-gradient(135deg, var(--t-cyan), var(--t-purple))",
              color: "#fff",
          ...
          {/* Intake CTA — visual connector to how-i-start */}
          <Link
            href={`/${locale}/how-i-start`}
            className="rv d5 sc-contact-cta-intake"
            style={{
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              ...
              background: "var(--t-bg)",
              border:
                "1px solid color-mix(in srgb, var(--t-cyan) 25%, transparent)",
              color: "var(--t-cyan)",
              fontFamily: "var(--font-mono)",
              fontSize: 11,
              fontWeight: 600,
